...
namespace TransportAnimals.Helpers
{
    ...
    public class GreaterAttribute : ValidationAttribute
    {
        ...
        public GreaterAttribute(long minimum)
        {
            Minimum = minimum;
        ...
        /// </summary>
        /// <param name="minimum">The minimum value, exclusive</param>
        public GreaterAttribute(double minimum)
        {
            Minimum = minimum;
        ...
        {
            return string.Format(CultureInfo.CurrentCulture, $"The value of {name} must be greater than {Minimum}", name, Minimum);
        }
