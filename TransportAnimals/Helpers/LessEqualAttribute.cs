...
namespace TransportAnimals.Helpers
{
    ...
    public class LessEqualAttribute : ValidationAttribute
    {
        ...
        /// </summary>
        /// <param name="maximum">The maximum value, exclusive</param>
        public LessEqualAttribute(double maximum)
        {
            Maximum = maximum;
        ...
        {
            return string.Format(CultureInfo.CurrentCulture, $"The value of {name} must be less than or equal to {Maximum}", name, Maximum);
        }
